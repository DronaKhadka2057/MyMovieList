    ...
    return(
        ...
        <div className={styles.main}>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div>
                <div className={styles.colorblack}>Cast (separate with a comma)</div>
                <textarea
                    name="cast"
                    value={formData.cast}
                    onChange={handleChange}
                ...
                <div className={styles.buttoncontainer}>
                  <button type="button" onClick={handleDelete} className={styles.deletebutton} > Delete Movie </button>
                  <button type="submit" className={styles.submitbutton}> Update Movie </button>
                </div>
            </form>
            </div>
        </div>
